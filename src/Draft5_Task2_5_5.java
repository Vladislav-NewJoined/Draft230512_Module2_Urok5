...
//                "столько, сколько букв ввел пользователь. Скопируйте в него буквы из первого массива\n\nРешение: ");
        ...
        do {
            ...
            break;
        } while (entered_Letter.equals("ю")); /*while (entered_Letter.equals("ю"));*/
        System.out.println();
        System.out.println("Введена буква 'ю'. Ввод букв завершен.");
        /*System.out.println(chars);*/
        /*System.out.println(chars_Lenth_Real);*/
...
//        } while (entered_Letter.equals("ю")); /*while (entered_Letter.equals("ю"));*/
//
//        System.out.println("Введена буква 'ю'. Конец программы.");
//    }
